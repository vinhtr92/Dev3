...
<ul>
	...
	<li class="hide"><a href="#form-page"><i class="icon-folder"></i> <?php echo JText::_('JSN_UNIFORM_PAGES'); ?> <?php
							$edition = defined('JSN_UNIFORM_EDITION') ? JSN_UNIFORM_EDITION : "free";
	...
	<div class="row-fluid form-horizontal">
		...
		<div class="span6">
			<fieldset>
                ...
                <div class="control-group">
                    <label class="control-label jsn-label-des-tipsy" original-title="<?php echo JText::_('JSN_UNIFORM_AJAX_UPLOAD_DES'); ?>"><?php echo JText::_('JSN_UNIFORM_AJAX_UPLOAD'); ?></label>

                    <div class="controls">
                        <?php echo $this->_form->getInput('form_ajax_upload') ?>
                    </div>
                </div>
				<div class="control-group">
				...
				<div id="recaptcha-hide-if-logged-in" class="control-group hide">
					<label class="control-label jsn-label-des-tipsy" original-title="<?php echo JText::_('JSN_UNIFORM_HIDE_CAPTCHA_IF_LOGGED_IN_DES'); ?>"><?php echo JText::_('JSN_UNIFORM_HIDE_CAPTCHA_IF_LOGGED_IN'); ?></label>

					<div class="controls">
						<?php echo $this->_form->getInput('form_hide_captcha_if_logged_in') ?>
					</div>
				</div>
				<div class="control-group">
...
<div id="formStyleButtons">
    ...
    <div class="control-group">
        <label class="control-label"><?php echo $this->_item->form_btn_preview_text ? JText::_($this->_item->form_btn_preview_text) : JText::_('PREVIEW'); ?></label>

        <div class="controls">
            <select class="input-large jsn-select2" name="form_style[button_preview_color]" id="button_preview_color">
                <?php
                $buttonPreviewColor = !empty($this->formStyle->button_preview_color) ? $this->formStyle->button_preview_color : "btn";
                echo JSNUniformHelper::renderOptionsButtonStyle($buttonPreviewColor);
                ?>
            </select>
        </div>
    </div>
				...
				<div class="ui-sortable jsn-sortable-disable">
					...
					<div class="form-payments ui-state-default jsn-iconbar-trigger">
						...
						<div class="payment-total-money">
							<?php $formSettings = !empty($this->_item->form_settings) ? json_decode($this->_item->form_settings) : "";?>
							<h3><span class="payment-text"><?php echo $formSettings->form_payment_money_value_text ? JText::_($formSettings->form_payment_money_value_text) : JText::_('JSN_UNIFORM_TOTAL_MONEY'); ?></span><span class="total-money"><?php echo $formSettings->form_payment_money_value ? JText::_($formSettings->form_payment_money_value) : ''; ?></span></h3>
				...
				<div class="ui-sortable jsn-sortable-disable">
					<div class="form-actions ui-state-default jsn-iconbar-trigger">
						<div class="<?php echo $buttonPosition;?>">
							...
							{
								?>
                                <button class="<?php echo $buttonPreviewColor." ".$stateBtnPreview;?> jsn-form-preview" onclick="return false;"><?php echo $formSettings->form_btn_preview_text ? JText::_($formSettings->form_btn_preview_text) : JText::_('PREVIEW'); ?></button>
							...
							else
							{
                                ...
                                <button class="<?php echo $buttonPreviewColor;?> jsn-form-preview hide" onclick="return false;"><?php echo $formSettings->form_btn_preview_text ? JText::_($formSettings->form_btn_preview_text) : JText::_('PREVIEW'); ?></button>
                            ...
                            <input type="hidden" id="jform_form_btn_preview_text" name="jsn_form_button[form_btn_preview_text]" value="<?php echo !empty($formSettings->form_btn_preview_text) ? $formSettings->form_btn_preview_text : JText::_('PREVIEW');?>">
                            <input type="hidden" id="jform_form_state_btn_preview_text" name="jsn_form_button[form_state_btn_preview_text]" value="<?php echo !empty($formSettings->form_state_btn_preview_text) ? $formSettings->form_state_btn_preview_text : "No";?>">
...
<div id="form-page">
    <div class="row-fluid">
    	<div id="form-page-loading" class="jsn-bgloading hide">
			<i class="jsn-icon32 jsn-icon-loading"></i>
		</div>
    	<ul id="jsnuf-page-sortable" class="jsn-items-list jsn-pages-list ui-sortable">
...
<div id="form-script">
	...
	<?php if ($user->authorise('core.manage', 'com_uniform')) { ?>
		<div class="span6">
			<fieldset>
	...
	<?php } else { ?>
		<div class="span12"><span class="alert alert-info"style="width: 100%;text-align: center;width:100%;float:left;"><?php echo JText::_('JSN_UNIFORM_SCRIPT_ONLY_FOR_ADMINISTRATOR_PRIVILEGE'); ?></span></div>
	<?php } ?>
	</div>
</div>
